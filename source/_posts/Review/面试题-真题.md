...
2、获取权限数据，用户权限初始化，后端返回路由和资源权限数据。异步加载路由组件，addRoutes()方法实现动态路由及菜单。
2、页面路由，用户登录后只能看到自己有权访问的导航菜单，也只能访问自己有权访问的路由地址，否则将跳转 4xx 提示页。路由钩子beforeEach和动态路由。
3、按钮元件，显示隐藏用指令做，指令仅使用bind回调，防止无谓的代码执行；
4、接口请求控制，http请求拦截器，拦截越权请求。

https://refined-x.com/2017/11/28/Vue2.0%E7%94%A8%E6%88%B7%E6%9D%83%E9%99%90%E6%8E%A7%E5%88%B6%E8%A7%A3%E5%86%B3%E6%96%B9%E6%A1%88/#%E8%B7%AF%E7%94%B1%E6%8E%A7%E5%88%B6

* 页面权限
所有的前端路由配置在后端，对于不同角色的用户，后端把路由列表吐给前端注册。导航栏菜单是否可见、校验url能否跳转。
...
权限  https://mp.weixin.qq.com/s/b-D2eH1mLwL_FkaZwjueSw
